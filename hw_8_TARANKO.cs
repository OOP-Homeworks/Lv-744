...
namespace hw_8_Taranko
{
    internal class hw_8_TARANKO
    {
        ...
        {
            List<Shape_Taranko> shapeList = new List<Shape_Taranko>(COUNTOFSHAPES);
            for (int i = 0; i < COUNTOFSHAPES / 2; i++) {
                ...
                shapeList.Add(new Circule_Taranko(tempRadious, "Circle"));
            }
            ...
            for (int i = 0; i < COUNTOFSHAPES / 2; i++)
            {
                ...
                shapeList.Add(new Square_Taranko(tempSide, "Square"));
            }
            Console.WriteLine("\n\n\n");
        ...
        static void maxPerimeter(List<Shape_Taranko> shapeList) {
            Shape_Taranko temp_max = shapeList[0];
